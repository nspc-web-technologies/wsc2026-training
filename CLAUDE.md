...
- Meeting all marking criteria in `B/WSC2024_TP17_MB_making_scheme.csv`
- Correct JSON API outputs matching specification examples
- Server-side validation where explicitly required (GTIN format)
- Delivering all required deliverables (DB dump, ER diagram, expert_readme.txt)
- Making it work in Firefox Developer Edition browser
- Getting it done within competition time constraints
