...
<template>
  <div class="weathers-view">
    <div class="scroll">
      <ul class="weathers">
        <li v-for="weather in weathers" :key="weather.name">
          <p>{{ weather.date }}</p>
          <p>
            <svg v-if="weather.status === 'Sunny'" version="1.1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200" viewBox="0 0 96 96"
		...
		S55.72,34,48,34z M48,58c-5.514,0-10-4.486-10-10s4.486-10,10-10s10,4.486,10,10S53.514,58,48,58z" />
            ...
            <svg v-if="weather.status === 'Cloudy'" version="1.1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200" viewBox="0 0 96 96"
              enable-background="new 0 0 96 96" xml:space="preserve">
              <g id="Base" display="none">
              </g>
            ...
            <svg v-if="weather.status === 'Rainy'" version="1.1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200" viewBox="0 0 96 96"
              enable-background="new 0 0 96 96" xml:space="preserve">
              <g id="Base" display="none">
              </g>
			...
			C42.677,79.981,42.84,80,43.001,80c0.896,0,1.711-0.606,1.939-1.515l6-24C51.208,53.413,50.557,52.328,49.485,52.06z" />
                  <path
                    d="M57.484,58.06c-1.072-0.271-2.157,0.384-2.425,1.455l-3,12c-0.268,1.072,0.384,2.158,1.456,2.426
			c0.163,0.041,0.326,0.06,0.486,0.06c0.896,0,1.712-0.606,1.939-1.515l2.999-12C59.208,59.413,58.556,58.327,57.484,58.06z" />
                  <path
                    d="M38.484,58.06c-1.069-0.271-2.157,0.384-2.425,1.455l-3,12c-0.268,1.072,0.384,2.158,1.456,2.426
...
.scroll ul li svg:hover {
  animation: stroke-animation 2s linear forwards;
