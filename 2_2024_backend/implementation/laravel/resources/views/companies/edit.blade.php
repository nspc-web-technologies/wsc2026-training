...
@section('body')
    ...
    <form action="{{route('companies.update',$company->id)}}" method="post">
        ...
        <p><label for="contact_email_address">連絡先メールアドレス:<input type="text" value="{{old('contact_email_address',$company->contact_email_address)}}" name="contact_email_address" id="contact_email_address"></label></p>
